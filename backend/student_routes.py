...
import os
import re
from backend.learning_utils import mark_lesson_complete
...
from backend.services.ai.assistant_service import get_available_agents
from backend.services.ai.learning_feed_service import generate_learning_feed
from backend.services.ai.learning.learning_insights_service import get_learning_insights
from backend.services.ai.skills.skill_graph_service import get_dashboard_skill_progress
...
from backend.services.wallet_service import get_wallet_balance
from backend.services.reward_service import build_reward_history, get_referral_rewards
import json
