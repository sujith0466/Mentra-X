...
from backend.services.ai.project_idea_service import generate_project_ideas, normalize_domain
from backend.services.ai.projects.project_blueprint_service import generate_project_blueprint
from backend.services.ai.projects.project_progress_service import get_recent_student_projects
