...
from models import Course, CodingChallenge, CodingSubmission, Enrollment, InterviewSession, ProjectIdea, StudentProject, Video, UserResume, db
...
from services.ai.career.resume_service import CAREER_SKILL_MAP, SKILL_KEYWORDS, analyze_resume
