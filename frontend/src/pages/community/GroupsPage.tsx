...
export const GroupsPage: React.FC = () => {
  const [groups, setGroups] = useState<Group[]>([
    {
      id: "grp-1",
      name: "Vector Memory & RAG Study Guild",
      ...
      tags: ["VectorDB", "Memory", "Python"],
    },
    {
      id: "grp-2",
      name: "Multi-Agent Architects & Engineers",
      ...
      tags: ["Engines", "Swarm", "Agents"],
    },
    {
      id: "grp-3",
      name: "AI Safety Security & Governance Guild",
      category: "AI Safety",
      membersCount: 64,
