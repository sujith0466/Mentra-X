...
export const ManageCoursesPage: React.FC = () => {
  const courses: CourseRow[] = [
    ...
    { id: "ml-303", title: "Vector Memory Systems & Qdrant Engineering", category: "AI & Machine Learning", modules: 10, students: 280, aiTutor: "Enabled", status: "Published" },
    { id: "sec-404", title: "AI Safety & Enkrypt Governance Layer Implementation", category: "Security & Governance", modules: 6, students: 150, aiTutor: "Enabled", status: "Published" },
  ];
  ...
  const columns: Column<CourseRow>[] = [
    ...
    { key: "aiTutor", title: "Mastra Swarm", render: (item) => <Badge variant="cyan" size="sm">{item.aiTutor}</Badge> },
    ...
    <div className="space-y-8 py-6">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-obsidian-600 pb-6">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">Configure AI tutor embeddings, syllabus prerequisites, and Qdrant indexing.</p>
        </div>
