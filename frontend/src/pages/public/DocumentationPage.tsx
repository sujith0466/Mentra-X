...
export const DocumentationPage: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: "sdk", label: "Developer SDKs", icon: Code },
  ];
  ...
  return (
    <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8 space-y-12">
      ...
      {/* Navigation Tabs */}
      <div className="max-w-4xl mx-auto flex flex-wrap justify-center gap-2 border-b border-white/10 pb-4">
        {tabs.map((t) => {
          const Icon = t.icon;
          ...
          <div className="space-y-6">
            <Card variant="glow" className="p-8 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                <div className="p-4 rounded-xl bg-obsidian-900/80 border border-white/10 space-y-2">
          ...
          <div className="space-y-6">
            <Card variant="default" className="p-8 space-y-6">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-obsidian-900 border border-white/10 font-mono text-xs space-y-2">
            ...
            <Card variant="gradient" className="p-8 space-y-6">
              ...
              <ul className="space-y-3 text-sm text-slate-300 pt-2">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-white">Real-Time Hallucination Interception:</strong> Every AI claim is verified against authoritative course embeddings using cosine similarity thresholds (&gt;0.85 required).
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-white">PII & Credentials Redaction:</strong> Student personal identifiers, passwords, and API keys are automatically stripped from prompts before swarm dispatch.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
                  <div>
                    <strong className="text-white">Prompt Injection Defense:</strong> Semantic heuristics block adversarial jailbreaks or attempts to override system pedagogical directives.
                  </div>
                </li>
              </ul>
            </Card>
          ...
          <div className="space-y-6">
            <Card variant="glass" className="p-8 space-y-6">
              <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                ...
                Mentra X Developer SDKs & Integrations
              </h2>
              <p className="text-sm text-slate-300">
              ...
              <div className="p-4 rounded-xl bg-obsidian-950 border border-white/10 font-mono text-xs text-slate-300 overflow-x-auto">
                <code>
