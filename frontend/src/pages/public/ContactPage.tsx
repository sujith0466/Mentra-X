  ...
  return (
    <div className="py-8 max-w-4xl mx-auto space-y-12">
      <div className="text-center space-y-3">
        ...
        <p className="text-sm text-slate-400">Have questions about Mentra X? We're here to help.</p>
      </div>
          ...
          <Card variant="glass" className="p-6">
            {submitted ? (
              <div className="py-12 text-center space-y-4">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300">Our enterprise solutions architect will respond within 24 hours.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Input label="Enterprise Email" type="email" placeholder="Enter your enterprise or university email" value={email} onChange={(e) => setEmail(e.target.value)} required />
                <div className="flex flex-col space-y-1.5">
                  <label className="text-sm font-medium text-slate-600 dark:text-slate-300">How can we help?</label>
                  <textarea
                    rows={4}
                    ...
                    required
                    className="w-full rounded-lg bg-slate-50 dark:bg-obsidian-900 border border-slate-200 dark:border-obsidian-600 px-3 py-2 text-sm text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all"
                  />
                </div>
