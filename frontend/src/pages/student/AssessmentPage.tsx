...
export const AssessmentPage: React.FC = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      question: "Why would an enterprise architecture team choose a hybrid MySQL + Qdrant storage model over a standalone vector DB?",
      options: [
        "Qdrant cannot store string characters.",
        "MySQL provides ACID transactional integrity for relational users/courses, while Qdrant specializes in high-dimensional semantic similarity search.",
        "MySQL runs faster than memory RAM.",
        "Vector databases do not support network HTTP protocols.",
      ],
      correct: 1,
      difficulty: "Advanced",
    },
          ...
          >
            <Card variant="glow" className="p-8 space-y-6 text-center">
              ...
              <div className="space-y-2">
                <h2 className="text-2xl font-bold text-white">Ready to Seed Your Digital Twin?</h2>
                <p className="text-sm text-slate-300 max-w-md mx-auto">
                  This 4-question adaptive evaluation tests your foundations across Algorithms, Transformer Architectures, Hybrid Database Systems, and Cognitive Swarms.
                </p>
              </div>
                  ...
                  return (
                    <button
                      ...
                      className={`w-full p-4 rounded-xl text-left border text-sm font-medium transition-all flex items-center justify-between ${
                        isSelected
                          ? "bg-gradient-to-r from-indigo-600/20 to-cyan-600/20 border-indigo-500 text-white shadow-md shadow-indigo-500/10"
                          : "bg-obsidian-900/60 border-white/10 text-slate-300 hover:bg-obsidian-800/80 hover:border-white/20"
                      }`}
                    >
                      <span className="flex items-center gap-3">
                        <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${
                          isSelected ? "bg-indigo-500 text-white" : "bg-obsidian-800 text-slate-400 border border-white/10"
                        }`}>
            ...
            <Card variant="gradient" className="p-8 text-center space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl mx-auto text-left pt-2">
                ...
                <div className="p-4 rounded-xl bg-obsidian-950/80 border border-white/10 space-y-1">
                  ...
                  <span className="text-lg font-bold text-indigo-400">Multi-Agent Cognitive Swarms</span>
                </div>
              </div>
