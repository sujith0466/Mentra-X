...
import { BrainCircuit, BookOpen, Clock, Flame, ArrowRight, CheckCircle2, Award, Zap, TrendingUp, Target, Compass } from "lucide-react";
    ...
    <div className="space-y-8 py-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-5">
          ...
          {/* Phase 10 Opportunity Center Highlight Card */}
          <Card className="p-4 bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-transparent border-indigo-500/30">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400">
                Phase 10 • Opportunity Intelligence
              </span>
              <Badge variant="success" size="sm">92.5% Top Match</Badge>
            </div>
            <h4 className="text-sm font-bold text-slate-900 dark:text-white">
              Google Software Engineering Summer Internship
            </h4>
            <p className="text-xs text-slate-600 dark:text-slate-300 mt-1">
              Multi-factor match verified with your Digital Twin &amp; Habit Score.
            </p>
            <div className="mt-3">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            {[
              ...
              { to: "/student/opportunities", label: "Opportunities",  icon: Compass,      color: "text-purple-600 dark:text-purple-400", bg: "bg-purple-50 dark:bg-purple-500/10" },
