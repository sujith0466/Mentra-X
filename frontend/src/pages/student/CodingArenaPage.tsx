...
export const CodingArenaPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 py-4">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-obsidian-600 pb-4">
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card variant="default" className="p-4 space-y-3 flex flex-col h-[500px]">
          <div className="flex items-center justify-between pb-2 border-b border-obsidian-600 text-xs text-slate-400 font-mono">
          ...
          <textarea
            ...
            className="w-full flex-1 bg-obsidian-950 border border-obsidian-600 rounded-lg p-4 font-mono text-xs text-slate-100 focus:outline-none focus:ring-1 focus:ring-primary-500 resize-none leading-relaxed"
          />
        </Card>
        ...
        <div className="space-y-6 flex flex-col justify-between">
          <Card variant="default" className="p-4 space-y-3 flex-1 flex flex-col">
            <div className="flex items-center justify-between pb-2 border-b border-obsidian-600 text-xs font-semibold text-white">
