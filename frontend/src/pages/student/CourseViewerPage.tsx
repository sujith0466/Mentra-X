    ...
    <div className="space-y-6 py-4">
      <div className="flex items-center justify-between border-b border-obsidian-600 pb-4">
        <div className="flex items-center space-x-4">
          <Link to="/student/my-courses" className="p-2 rounded-lg bg-obsidian-800 border border-obsidian-600 hover:bg-obsidian-700 transition-colors">
          ...
          <div>
            ...
            <h1 className="text-xl font-bold text-white mt-1">Deterministic Tool Execution in Swarms</h1>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="aspect-video w-full rounded-2xl bg-obsidian-950 border border-obsidian-600 relative overflow-hidden flex items-center justify-center shadow-2xl group">
            <div className="absolute inset-0 bg-gradient-to-tr from-indigo-950/40 via-obsidian-900 to-transparent" />
            <div className="text-center z-10 space-y-4">
              <div className="w-16 h-16 rounded-full bg-primary-600 text-white flex items-center justify-center mx-auto shadow-lg shadow-indigo-500/30 group-hover:scale-110 transition-transform cursor-pointer">
                <Play className="w-8 h-8 fill-current ml-1" />
              </div>
              <span className="text-sm font-semibold text-slate-300 block">Click to Start Interactive Video Lecture</span>
            </div>
          </div>

          <div className="flex border-b border-obsidian-600 space-x-4">
          ...
          {activeTab === "notes" && (
            <Card variant="default" className="p-4 space-y-3">
              <h4 className="font-semibold text-sm text-white">Student Study Notes</h4>
              <textarea
                rows={6}
                placeholder="Type your lecture notes here... They will automatically sync with your Digital Twin."
                className="w-full rounded-lg bg-obsidian-900 border border-obsidian-600 p-3 text-sm text-slate-200 focus:outline-none focus:ring-2 focus:ring-primary-500"
              />
              ...
              {[
                ...
                <div
                  ...
                  className={`p-3 rounded-xl border flex items-center justify-between ${
                    mod.status === "active"
                      ? "bg-primary-600/10 border-primary-500/40 text-white font-semibold"
                      : "bg-obsidian-900/60 border-obsidian-600/50 text-slate-400"
                  }`}
                >
