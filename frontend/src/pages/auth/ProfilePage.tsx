    ...
    <div className="max-w-5xl mx-auto py-10 px-4 sm:px-6 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-white/10 pb-6">
        <div>
          ...
          <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white">Student Profile & Settings</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="space-y-6">
          <Card variant="glow" className="p-6 text-center space-y-4">
            <div className="relative w-24 h-24 mx-auto">
              <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-indigo-500 to-cyan-400 p-1">
                <div className="w-full h-full rounded-full bg-white dark:bg-obsidian-900 flex items-center justify-center text-2xl font-bold text-slate-900 dark:text-white">
                  {name.charAt(0)}
                </div>
              </div>
              <button className="absolute bottom-0 right-0 p-2 rounded-full bg-indigo-600 hover:bg-indigo-500 text-slate-900 dark:text-white shadow-lg border border-slate-300 dark:border-white/20 transition-all">
          ...
          <Card variant="default" className="p-6 space-y-4">
            <h4 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2">
              ...
              Learning Profile Knowledge State
            </h4>
            <div className="space-y-3 text-xs text-slate-600 dark:text-slate-300">
              ...
              <div className="w-full h-1.5 bg-slate-50 dark:bg-obsidian-900 rounded-full overflow-hidden">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card variant="default" className="p-8 space-y-6">
            <div className="flex justify-between items-center">
              <h3 className="text-lg font-bold text-slate-900 dark:text-white">Personal & Academic Details</h3>
              {saved && (
