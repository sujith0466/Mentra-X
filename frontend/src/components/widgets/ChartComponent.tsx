...
export const ChartComponent: React.FC<ChartComponentProps> = ({
  ...
  return (
    <Card variant="default" className={cn("p-5 space-y-4", className)}>
      <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-obsidian-600">
        ...
        {data.map((item, idx) => {
          ...
          return (
            <div key={idx} className="space-y-1">
              ...
              <div className="w-full h-2.5 rounded-full bg-slate-50 dark:bg-obsidian-900 border border-slate-200 dark:border-obsidian-600 overflow-hidden">
                <div
                  style={{ width: `${pct}%` }}
