...
export const DigitalTwinCard: React.FC<DigitalTwinCardProps> = ({
  ...
  return (
    <Card variant="glow" className={cn("relative overflow-hidden p-6", className)}>
      <div className="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-obsidian-600 mb-4">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-primary-600 to-ai-violet flex items-center justify-center shadow-lg shadow-indigo-500/30">
            <BrainCircuit className="w-6 h-6 text-slate-900 dark:text-white" />
          </div>
          <div>
            <div className="flex items-center space-x-2">
              <h4 className="font-bold text-slate-900 dark:text-white leading-none">{studentName}&apos;s Digital Twin</h4>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div className="p-3 rounded-lg bg-slate-50 dark:bg-obsidian-900 border border-slate-200 dark:border-obsidian-600/60 flex flex-col">
          <span className="text-xs text-slate-400 flex items-center gap-1">
            <Activity className="w-3.5 h-3.5 text-indigo-400" /> Health Score
          </span>
          <span className="text-xl font-bold text-slate-900 dark:text-white mt-1">{healthScore}/100</span>
        </div>
        <div className="p-3 rounded-lg bg-slate-50 dark:bg-obsidian-900 border border-slate-200 dark:border-obsidian-600/60 flex flex-col">
          <span className="text-xs text-slate-400 flex items-center gap-1">
            <Award className="w-3.5 h-3.5 text-ai-violet" /> Mastery
          </span>
          <span className="text-xl font-bold text-slate-900 dark:text-white mt-1">{knowledgeMastery}%</span>
        </div>
        <div className="p-3 rounded-lg bg-slate-50 dark:bg-obsidian-900 border border-slate-200 dark:border-obsidian-600/60 flex flex-col">
          <span className="text-xs text-slate-400 flex items-center gap-1">
            <Zap className="w-3.5 h-3.5 text-amber-400" /> Velocity
          </span>
          <span className="text-xl font-bold text-slate-900 dark:text-white mt-1">{studyVelocity}x</span>
        </div>
        <div className="p-3 rounded-lg bg-slate-50 dark:bg-obsidian-900 border border-slate-200 dark:border-obsidian-600/60 flex flex-col">
          <span className="text-xs text-slate-400 flex items-center gap-1">
            <Flame className="w-3.5 h-3.5 text-rose-400" /> Streak
          </span>
          <span className="text-xl font-bold text-slate-900 dark:text-white mt-1">{streakDays} Days</span>
        </div>
      </div>
    </Card>
  );
